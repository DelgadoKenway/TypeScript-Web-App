...
var input = document.getElementById("conversion");
var toGramButton = document.getElementById("ToG");
var toOuncesButton = document.getElementById("ToO");
var outputdiv = document.getElementById("output");
function convToG() {
    var weight = Number(input.value);
    var result = weight * 28.3495231;
    outputdiv.textContent = ("" + result);
}
function convToO() {
    var weight = Number(input.value);
    var result = weight * 0.0352739619;
    outputdiv.textContent = ("" + result);
}
